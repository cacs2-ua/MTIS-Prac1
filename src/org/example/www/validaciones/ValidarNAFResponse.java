 ...
 */
            ...
            /**
            *  ValidarNAFResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidarNAFResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validarNAFResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validarNAFResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidarNAFResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarNAFResponse object =
                new ValidarNAFResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validarNAFResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarNAFResponse)org.example.www.validaciones.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
