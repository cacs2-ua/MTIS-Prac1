 ...
 */
            ...
            /**
            *  ValidarNIEResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidarNIEResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validarNIEResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validarNIEResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidarNIEResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarNIEResponse object =
                new ValidarNIEResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validarNIEResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarNIEResponse)org.example.www.validaciones.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
