 ...
 */
            ...
            /**
            *  NuevoResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NuevoResponse
    ...
    public static class Factory{
        ...
        */
        public static NuevoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NuevoResponse object =
                new NuevoResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"nuevoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NuevoResponse)org.example.www.empleados.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
