...
/**
 * ControlPresenciaOperationType.java
 *
 ...
 */
            ...
            /**
            *  ControlPresenciaOperationType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ControlPresenciaOperationType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ControlPresenciaOperationType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ControlPresenciaOperationType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ControlPresenciaOperationType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ControlPresenciaOperationType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ControlPresenciaOperationType object =
                new ControlPresenciaOperationType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ControlPresenciaOperationType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ControlPresenciaOperationType)org.example.www.controlpresencia.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
