 ...
 */
            ...
            /**
            *  ControlEmpleadoSala bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ControlEmpleadoSala
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":controlEmpleadoSala",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "controlEmpleadoSala",
    ...
    public static class Factory{
        ...
        */
        public static ControlEmpleadoSala parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ControlEmpleadoSala object =
                new ControlEmpleadoSala();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"controlEmpleadoSala".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ControlEmpleadoSala)org.example.www.controlpresencia.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
