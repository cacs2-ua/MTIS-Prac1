 ...
 */
            ...
            /**
            *  RegistroAccesosType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RegistroAccesosType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = RegistroAccesosType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RegistroAccesosType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RegistroAccesosType",
    ...
    public static class Factory{
        ...
        */
        public static RegistroAccesosType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegistroAccesosType object =
                new RegistroAccesosType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RegistroAccesosType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RegistroAccesosType)org.example.www.controlaccesos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
