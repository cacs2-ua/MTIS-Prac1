        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected org.example.www.controlaccesos.InstanciaRegistroAccesosType[] localOut ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.example.www.controlaccesos.InstanciaRegistroAccesosType[]
                           */
                           public  org.example.www.controlaccesos.InstanciaRegistroAccesosType[] getOut(){
                               return localOut;
                           }
                               ...
                               */
                              protected void validateOut(org.example.www.controlaccesos.InstanciaRegistroAccesosType[] param){
                              ...
                              * @param param Out
                              */
                              public void setOut(org.example.www.controlaccesos.InstanciaRegistroAccesosType[] param){
                             ...
                             * @param param org.example.www.controlaccesos.InstanciaRegistroAccesosType
                             */
                             public void addOut(org.example.www.controlaccesos.InstanciaRegistroAccesosType param){
                                   if (localOut == null){
                                   localOut = new org.example.www.controlaccesos.InstanciaRegistroAccesosType[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localOut);
                               list.add(param);
                               this.localOut =
                             (org.example.www.controlaccesos.InstanciaRegistroAccesosType[])list.toArray(
                            new org.example.www.controlaccesos.InstanciaRegistroAccesosType[list.size()]);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"consultarResponse".equals(type)){
                                ...
                                return (ConsultarResponse)org.example.www.controlaccesos.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(org.example.www.controlaccesos.InstanciaRegistroAccesosType.Factory.parse(reader));
                                                        ...
                                                        object.setOut((org.example.www.controlaccesos.InstanciaRegistroAccesosType[])
